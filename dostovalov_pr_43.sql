...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 09 2021 г., 21:57
...
(8, 'Проверка', 'Проверка', 'Проверка', '2021-11-09', '7f6d3aff0221785dbabeb01afab4acca.png', NULL, NULL, NULL, 3),
(9, 'Статья 1', 'Статья 1', 'Статья 1', '2021-11-09', NULL, NULL, NULL, NULL, 2);
