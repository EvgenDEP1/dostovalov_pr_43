            ...
            <div class="row">
                <div class="col-md-8">
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                <h6><a href="#"> Путешествия</a></h6>

                                <h1 class="entry-title"><a href="blog.html">Дом - это спокойное место</a></h1>
                            ...
                            <div class="social-share">
                                <span class="social-share-title pull-left text-capitalize">Автор <a href="#">Рубель</a> На Ноябрь 9, 2021</span>
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                <h6><a href="#">Искусство</a></h6>

                                <h1 class="entry-title"><a href="blog.html">деревянный стол красивый</a></h1>
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                ...
                                <h1 class="entry-title"><a href="blog.html">Небольшая рабочая станция</a></h1>
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                ...
                                <h1 class="entry-title"><a href="blog.html">Ожидание запуска в небо</a></h1>
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                <h6><a href="#">Ткань</a></h6>

                                <h1 class="entry-title"><a href="blog.html">Дневной рабочий носил джинсы</a></h1>
